...
namespace NetworkConnector
{
    public static class StringCipher
    {
        ...
        private const string pass = "BlameBart";

        /// <summary>
        ///     decrypt a code
        /// </summary>
        /// <param name="cipher">string chipher</param>
        /// <returns>returns the decrypted string</returns>
        public static string Decrypt(string cipher)
        {
            return Decrypt(cipher, pass);
        }
        ...
        ///     encrypt a code
        /// </summary>
        /// <param name="cipher">string plainText</param>
        /// <paramref name="passPhrase" />
        /// string passphrase
        /// </param>
        ...
        {
            return Encrypt(cipher, pass);
        }

        /// <summary>
        ///     generate 256 bits of random entropy
        /// </summary>
        /// <returns>returns a byte[] with the random generated entropys</returns>
